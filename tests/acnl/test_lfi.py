...
from acnl.control import LocalFieldIntegrator, LFIConfig
from acnl.energy import EnergyObservableKind
...
def test_tau_limit_computation():
    ...
    compute_nodes = [k for k in tau_limits.keys() if "compute-node" in str(k)]
